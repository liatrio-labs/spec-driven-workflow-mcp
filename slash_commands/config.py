...
_SUPPORTED_AGENT_DATA: tuple[tuple[str, str, str, CommandFormat, str, tuple[str, ...]], ...] = (
    ...
    ("amp", "Amp", ".agents/commands", CommandFormat.MARKDOWN, ".md", (".agents",)),
    ("auggie-cli", "Auggie CLI", ".augment/commands", CommandFormat.MARKDOWN, ".md", (".augment",)),
    ...
    ("kilo-code", "Kilo Code", ".kilocode/rules", CommandFormat.MARKDOWN, ".md", (".kilocode",)),
    (
        "opencode",
        "opencode",
